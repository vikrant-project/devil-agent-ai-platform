...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("reload-mcp", "Reload MCP servers from config", "Tools & Skills",
               aliases=("reload_mcp",)),
    CommandDef("reload-skills", "Re-scan ~/.devil/skills/ for newly installed or removed skills",
    ...
    CommandDef("update", "Update Devil Agent to the latest version", "Info",
               gateway_only=True),
...
def _iter_plugin_command_entries() -> list[tuple[str, str, str]]:
    ...
    :func:`devil_cli.plugins.PluginContext.register_command`. They behave
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    entries.append(("devil", "Talk to Hermes or run a subcommand", "[subcommand] [args]"))
    seen.add("devil")
