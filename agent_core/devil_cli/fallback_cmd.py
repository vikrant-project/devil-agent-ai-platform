...
Storage: ``fallback_providers`` in ``~/.devil/config.yaml`` (top-level, list of
...
def _restore_auth_active_provider(value: Any) -> None:
    ...
    try:
        from devil_cli.auth import _auth_store_lock, _load_auth_store, _save_auth_store
...
def cmd_fallback_add(args) -> None:
    ...
    from devil_cli.main import _require_tty, select_provider_and_model
