"""
Security advisory checker for Devil Agent.
...
ADVISORIES: tuple[Advisory, ...] = (
    Advisory(
        ...
        remediation=(
            ...
            "Rotate API keys in ~/.devil/.env (OpenRouter, Anthropic, OpenAI, "
...
# ``~/.devil/cache/advisory_banner_seen`` (a single line per advisory ID:
...
def _banner_cache_path() -> Optional[Path]:
    try:
        ...
        cache_dir = Path(get_devil_home()) / "cache"
