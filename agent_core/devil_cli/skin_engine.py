...
Skins are defined as YAML files in ~/.devil/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Devil Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Devil "       # Response box header label
...
.. code-block:: python
    ...
    from devil_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Devil Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.devil/skins/

BUILT-IN SKINS
==============

- ``default`` — Classic Devil gold/kawaii (the current look)
...
Drop a YAML file in ``~/.devil/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces DEVIL_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces DEVIL_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Devil — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Devil Agent",
            "welcome": "Welcome to Devil Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Devil ",
            "prompt_symbol": "❯",
