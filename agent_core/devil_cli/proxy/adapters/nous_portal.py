...
Reads the user's Nous OAuth state from ``~/.devil/auth.json``, refreshes
...
already handles both — see :func:`devil_cli.auth.refresh_nous_oauth_from_state`.
"""
...
class NousPortalAdapter(UpstreamAdapter):
    ...
    # to devil_cli.auth to avoid expanding that module's public surface.
    # ------------------------------------------------------------------
