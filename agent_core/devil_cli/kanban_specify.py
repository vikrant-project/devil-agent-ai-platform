...
* This module intentionally mirrors ``devil_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Devil Agent board.
...
def _profile_author() -> str:
    """Mirror of ``devil_cli.kanban._profile_author``. Kept local to
    avoid a circular import when kanban.py imports this module."""
    return (
        os.environ.get("DEVIL_PROFILE")
