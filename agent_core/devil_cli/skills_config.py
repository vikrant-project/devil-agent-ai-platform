...
from devil_cli.config import cfg_get, load_config, save_config
from devil_cli.colors import Colors, color
from devil_cli.platforms import PLATFORMS as _PLATFORMS
