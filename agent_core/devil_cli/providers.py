"""
Single source of truth for provider identity in Devil Agent.
...
DEVIL_OVERLAYS: Dict[str, HermesOverlay] = {
    ...
    "qwen-oauth": HermesOverlay(
        ...
        base_url_env_var="DEVIL_QWEN_BASE_URL",
    ),
...
class ProviderDef:
    ...
    doc: str = ""
    source: str = ""                      # "models.dev", "devil", "user-config"
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    overlay = DEVIL_OVERLAYS.get(canonical)
...
def determine_api_mode(provider: str, base_url: str = "") -> str:
    ...
    # Direct provider checks for providers not in DEVIL_OVERLAYS
    if provider == "bedrock":
