...
_DEVIL_CORE_TOOLS = [
    ...
    # spawned as a kanban worker (DEVIL_KANBAN_TASK env set) or the current
...
TOOLSETS = {
    ...
    "kanban": {
        "description": (
            ...
            "is spawned by the kanban dispatcher (DEVIL_KANBAN_TASK env "
...
def resolve_toolset(name: str, visited: Set[str] = None) -> List[str]:
    ...
    if not toolset:
        ...
        # Gives them _DEVIL_CORE_TOOLS plus any tools the plugin registered
        ...
        if name.startswith("hermes-"):
            ...
            try:
                ...
                if platform_registry.is_registered(platform_name):
                    plugin_tools = set(_DEVIL_CORE_TOOLS)
                    try:
                        from tools.registry import registry
                        plugin_tools.update(
