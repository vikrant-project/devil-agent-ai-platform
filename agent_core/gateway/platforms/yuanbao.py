...
try:
    ...
    _DEVIL_VERSION = "0.0.0"

_APP_VERSION = _DEVIL_VERSION
_BOT_VERSION = _DEVIL_VERSION
_YUANBAO_INSTANCE_ID = str(DEVIL_INSTANCE_ID)  # single source: yuanbao_proto.DEVIL_INSTANCE_ID
