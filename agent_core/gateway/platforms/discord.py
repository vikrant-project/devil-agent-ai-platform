...
def _read_dm_role_auth_guild() -> Optional[int]:
    ...
    policy, ``~/.devil/.env`` is for secrets only, and this is a
...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._text_batch_delay_seconds = float(os.getenv("DEVIL_DISCORD_TEXT_BATCH_DELAY_SECONDS", "0.6"))
        self._text_batch_split_delay_seconds = float(os.getenv("DEVIL_DISCORD_TEXT_BATCH_SPLIT_DELAY_SECONDS", "2.0"))
    ...
    def _command_sync_state_path(self) -> _Path:
        ...
        directory = get_devil_home() / _DISCORD_COMMAND_SYNC_STATE_SUBDIR
        try:
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reload-skills", description="Re-scan ~/.devil/skills/ for new or removed skills")
        ...
        @tree.command(name="update", description="Update Devil Agent to the latest version")
        ...
        # devil_cli/commands.py automatically appear as Discord slash
        ...
        try:
            from devil_cli.commands import COMMAND_REGISTRY, _is_gateway_available, _resolve_config_gates
        ...
        try:
            from devil_cli.commands import _iter_plugin_command_entries
    ...
    def _refresh_skill_catalog_state(self) -> None:
        ...
        """
        from devil_cli.commands import discord_skill_commands_by_category
    ...
    async def _auto_create_thread(self, message: 'DiscordMessage') -> Optional[Any]:
        ...
        thread_name = content[:80] if content else "Devil Agent"
        if len(content) > 80:
