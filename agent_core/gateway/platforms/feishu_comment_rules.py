...
Config: ~/.devil/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.devil/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_devil_home()`` helper (DEVIL_HOME-aware and
...
RULES_FILE = get_devil_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_devil_home() / "feishu_comment_pairing.json"
