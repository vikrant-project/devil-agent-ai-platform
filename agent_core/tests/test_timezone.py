"""
Tests for timezone support (devil_time module + integration points).
...
def _reset_devil_time_cache():
    """Reset the devil_time module cache (replacement for removed reset_cache)."""
    devil_time._cached_tz = None
    devil_time._cached_tz_name = None
    devil_time._cache_resolved = False


# =========================================================================
# devil_time.now() — core helper
# =========================================================================
...
class TestHermesTimeNow:
    ...
    def test_invalid_timezone_falls_back(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="devil_time"):
            result = devil_time.now()
