...
Verifies that:
 ...
 2. User plugins at $DEVIL_HOME/plugins/model-providers/<name>/ override bundled
...
def test_general_plugin_manager_skips_model_provider_kind(tmp_path, monkeypatch):
    ...
    from devil_cli import plugins as plugin_mod
    ...
    user_plugin = devil_home / "plugins" / "test-model-provider"
