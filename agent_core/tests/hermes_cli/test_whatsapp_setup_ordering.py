...
def isolated_home(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("DEVIL_HOME", str(hermes))
...
def _env_value(devil_home: Path, key: str) -> str | None:
...
def test_aborted_setup_does_not_enable_whatsapp(isolated_home, monkeypatch):
    ...
    monkeypatch.setattr("devil_cli.main._require_tty", lambda *_a, **_kw: None)
