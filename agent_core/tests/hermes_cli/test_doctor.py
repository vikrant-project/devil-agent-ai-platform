...
import devil_cli.doctor as doctor
import devil_cli.gateway as gateway_cli
from devil_cli import doctor as doctor_mod
from devil_cli.doctor import _has_provider_env_config
...
class TestDoctorEnvFileEncoding:
    ...
    def test_doctor_reads_env_as_utf8_even_when_locale_is_not_utf8(
        ...
        monkeypatch.setattr(doctor_mod, "DEVIL_HOME", devil_home)
...
class TestDoctorMemoryProviderSection:
    ...
    def _make_devil_home(self, tmp_path, provider=""):
        """Create a minimal DEVIL_HOME with config.yaml."""
        home = tmp_path / ".devil"
    ...
    def _run_doctor_and_capture(self, monkeypatch, tmp_path, provider=""):
        ...
        home = self._make_devil_home(tmp_path, provider)
...
class TestGitHubTokenCheck:
    ...
    def test_no_token_and_not_gh_authenticated_shows_warn(self, monkeypatch, tmp_path):
        ...
        from devil_cli.doctor import run_doctor, _DHH
        import io, contextlib
