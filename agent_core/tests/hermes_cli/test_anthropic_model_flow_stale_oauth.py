...
when a stale ANTHROPIC_TOKEN exists in ~/.devil/.env but no valid
...
from devil_cli.config import load_env, save_env_value
...
class TestStaleOAuthTokenDetection:
    ...
    def test_stale_oauth_token_triggers_reauth(self, tmp_path, monkeypatch, capsys):
        ...
        from devil_cli.main import _model_flow_anthropic
        cfg = {}
