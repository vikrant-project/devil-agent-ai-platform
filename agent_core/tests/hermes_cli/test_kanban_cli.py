"""Tests for the kanban CLI surface (devil_cli.kanban)."""
...
from devil_cli import kanban as kc
...
def test_kanban_in_autocomplete_table():
    from devil_cli.commands import COMMANDS, SUBCOMMANDS
...
def test_kanban_not_gateway_only():
    ...
    from devil_cli.commands import COMMAND_REGISTRY
