...
``is_nous_devil_non_agentic`` should only match the actual Nous Research
...
def test_matches_real_nous_hermes_chat_models(model_name: str) -> None:
    assert is_nous_devil_non_agentic(model_name), (
...
def test_does_not_match_unrelated_models(model_name: str) -> None:
    assert not is_nous_devil_non_agentic(model_name), (
...
def test_none_like_inputs_are_safe() -> None:
    assert is_nous_devil_non_agentic("") is False
