...
from devil_cli.commands import discord_skill_commands_by_category  # noqa: E402
...
class TestPluginCommandEnumeration:
    ...
    def _patch_plugin_commands(self, monkeypatch, commands):
        """Monkeypatch devil_cli.plugins.get_plugin_commands() to a fixed dict."""
        from devil_cli import plugins as _plugins_mod
    ...
    def test_is_gateway_known_command_recognizes_plugin_commands(self, monkeypatch):
        ...
        from devil_cli.commands import is_gateway_known_command
