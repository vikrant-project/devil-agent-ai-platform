...
import devil_cli.providers as providers_mod
...
def test_switch_model_accepts_explicit_named_custom_provider(monkeypatch):
    ...
    monkeypatch.setattr("devil_cli.models.validate_requested_model", lambda *a, **k: _MOCK_VALIDATION)
    monkeypatch.setattr("devil_cli.model_switch.get_model_info", lambda *a, **k: None)
    monkeypatch.setattr("devil_cli.model_switch.get_model_capabilities", lambda *a, **k: None)
...
def test_lmstudio_picker_probes_active_config_base_url(monkeypatch):
    ...
    monkeypatch.setattr("devil_cli.models.fetch_lmstudio_models", _fake_fetch)
