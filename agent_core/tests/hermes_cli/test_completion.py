"""Tests for devil_cli/completion.py — shell completion script generation."""
...
from devil_cli.completion import _walk, generate_bash, generate_zsh, generate_fish
...
class TestSubcommandDrift:
    def test_SUBCOMMANDS_covers_required_commands(self):
        ...
        """
        import inspect
        from devil_cli.main import _coalesce_session_name_args
...
class TestProfileCompletion:
    ...
    def test_bash_has_profiles_helper(self):
        ...
        assert 'profiles_dir="$HOME/.devil/profiles"' in out
    ...
    def test_zsh_has_profiles_helper(self):
        out = generate_zsh(_make_parser())
        assert "_hermes_profiles()" in out
        assert "$HOME/.devil/profiles" in out
