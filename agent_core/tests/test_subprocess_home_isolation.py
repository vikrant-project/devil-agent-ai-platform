...
class TestGetSubprocessHome:
    """Unit tests for devil_constants.get_subprocess_home()."""

    def test_returns_none_when_devil_home_unset(self, monkeypatch):
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("DEVIL_HOME", str(base / "alpha"))
        home_a = get_subprocess_home()

        monkeypatch.setenv("DEVIL_HOME", str(base / "beta"))
...
class TestMakeRunEnvHomeInjection:
    ...
    def test_injects_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        assert result["HOME"] == str(devil_home / "home")
    ...
    def test_no_injection_when_devil_home_unset(self, monkeypatch):
        monkeypatch.delenv("DEVIL_HOME", raising=False)
...
class TestProfileBootstrap:
    ...
    def test_profile_dirs_includes_home(self):
        from devil_cli.profiles import _PROFILE_DIRS
