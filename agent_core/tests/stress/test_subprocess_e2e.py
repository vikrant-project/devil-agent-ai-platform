...
This validates the IPC + lifecycle story that mocks can't:
  ...
  - the child process resolves devil_cli.kanban_db on its own
  ...
  - worker logs are captured to DEVIL_HOME/kanban/logs/<task>.log
