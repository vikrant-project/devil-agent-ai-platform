...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("devil_cli.config.get_config_path", return_value=config_path), \
             patch("devil_cli.config.ensure_devil_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("devil_cli.config.get_env_path", return_value=env_path), \
             patch("devil_cli.config.ensure_devil_home"):
    ...
    def test_ensure_devil_home_sets_0700(self):
        home = Path(self.tmpdir) / ".devil"
        with patch("devil_cli.config.get_devil_home", return_value=home):
