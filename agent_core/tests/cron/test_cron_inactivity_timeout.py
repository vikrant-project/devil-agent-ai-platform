...
class TestSysPathOrdering:
    ...
    def test_devil_time_importable(self):
        """devil_time should be importable when cron.scheduler loads."""
    ...
    def test_devil_constants_importable(self):
        """devil_constants should be importable from cron context."""
        from devil_constants import get_devil_home
        assert callable(get_devil_home)
