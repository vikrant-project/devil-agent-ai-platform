...
def _enable_managed_nous_tools(monkeypatch):
    ...
    devil_cli.auth and devil_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("devil_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("devil_cli.models.check_nous_free_tier", lambda: False)
