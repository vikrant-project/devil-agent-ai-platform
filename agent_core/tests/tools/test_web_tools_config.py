...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_devil_home_override(self, tmp_path):
        """Auth lookup should read from DEVIL_HOME/auth.json, not ~/.devil/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".devil").mkdir(parents=True)
