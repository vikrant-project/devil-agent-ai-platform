#!/usr/bin/env python3
"""Google Workspace API CLI for Devil Agent.
...
from _devil_home import get_devil_home
...
def _gws_binary() -> str | None:
    override = os.getenv("DEVIL_GWS_BIN")
    if override:
        return override
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for Devil Agent")
