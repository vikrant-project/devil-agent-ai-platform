...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("DEVIL_HOME", os.path.expanduser("~/.devil")), "skills/red-teaming/godmode/scripts/load_godmode.py")
    )).read())
...
_gm_scripts_dir = Path(os.getenv("DEVIL_HOME", Path.home() / ".devil")) / "skills" / "red-teaming" / "godmode" / "scripts"
