...
Data file: $DEVIL_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_DEVIL_HOME = Path(os.environ.get("DEVIL_HOME", Path.home() / ".devil"))
DATA_DIR = _DEVIL_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
