"""
Microsoft Teams platform adapter for Devil Agent.
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            self._app = App(
                ...
                client=ClientOptions(headers={"User-Agent": "Devil Agent"}),
            )
...
def interactive_setup() -> None:
    ...
    print()
    print_success("Teams configuration saved to ~/.devil/.env")
