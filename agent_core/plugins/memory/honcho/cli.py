...
def _local_config_path() -> Path:
    ...
    Always returns $DEVIL_HOME/honcho.json so each profile/instance gets
    ...
    """
    return get_devil_home() / "honcho.json"
...
def honcho_command(args) -> None:
    ...
    if sub == "setup":
        ...
        from devil_cli.memory_setup import cmd_setup_provider
