...
def _browser_candidate_path_dirs() -> list[str]:
    ...
    hermes_node_bin = str(devil_home / "node" / "bin")
    hermes_nm_bin = str(devil_home / "node_modules" / ".bin")
...
def _find_agent_browser() -> str:
    ...
    try:
        ...
        if ensure_dependency("browser"):
            ...
            if not recheck:
                hermes_nm = str(get_devil_home() / "node_modules" / ".bin")
...
def _maybe_start_recording(task_id: str):
    ...
    try:
        ...
        recordings_dir = devil_home / "browser_recordings"
