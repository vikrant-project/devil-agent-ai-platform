...
`mcp_tool.py`, and `devil_cli/mcp_config.py`. This module is the ONLY place
...
_DEVIL_PROVIDER_CLS: Optional[type] = _make_hermes_provider_class()
...
class MCPOAuthManager:
    ...
    def _build_provider(
        ...
        Returns None if the MCP SDK's OAuth support is unavailable.
        """
        if _DEVIL_PROVIDER_CLS is None:
            logger.warning(
