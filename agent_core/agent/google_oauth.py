...
Storage (``~/.devil/auth/google_oauth.json``, chmod 0o600):
...
#
# Resolution order:
#   1. DEVIL_GEMINI_CLIENT_ID / DEVIL_GEMINI_CLIENT_SECRET env vars (power users)
...
ENV_CLIENT_ID = "DEVIL_GEMINI_CLIENT_ID"
ENV_CLIENT_SECRET = "DEVIL_GEMINI_CLIENT_SECRET"
...
_HEADLESS_ENV_VARS = ("SSH_CONNECTION", "SSH_CLIENT", "SSH_TTY", "DEVIL_HEADLESS")
...
def _credentials_path() -> Path:
    return get_devil_home() / "auth" / "google_oauth.json"
...
def _require_client_id() -> str:
    ...
    if not cid:
        raise GoogleOAuthError(
            ...
            "  2. Set DEVIL_GEMINI_CLIENT_ID and DEVIL_GEMINI_CLIENT_SECRET in ~/.devil/.env\n"
            "\n"
