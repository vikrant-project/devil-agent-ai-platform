...
_DEVIL_TO_CODEX_PERMISSION_PROFILE = {
    ...
    def __init__(
        ...
        *,
        ...
        self._permission_profile = (
            permission_profile or _DEVIL_TO_CODEX_PERMISSION_PROFILE.get(
                os.environ.get("DEVIL_TERMINAL_SECURITY_MODE", "auto"),
                "workspace-write",
            )
        )
