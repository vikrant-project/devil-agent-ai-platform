...
Plugins built on Devil Agent often need to make their own LLM calls
...
:class:`~devil_cli.plugins.PluginContext`:
...
class PluginLlm:
    ...
    Instances are constructed by :class:`devil_cli.plugins.PluginContext`
