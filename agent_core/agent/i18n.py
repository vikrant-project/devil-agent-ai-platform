...
Language resolution order:
    ...
    2. ``DEVIL_LANGUAGE`` environment variable (for tests / quick override)
...
def reset_language_cache() -> None:
    ...
    Call after :func:`devil_cli.config.save_config` if a running process
...
def get_language() -> str:
    ...
    env_lang = os.environ.get("DEVIL_LANGUAGE")
    if env_lang:
