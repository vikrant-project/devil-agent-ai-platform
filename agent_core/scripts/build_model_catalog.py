...
# Ensure DEVIL_HOME is set for imports that touch it at module level.
os.environ.setdefault("DEVIL_HOME", os.path.join(os.path.expanduser("~"), ".devil"))

from devil_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
