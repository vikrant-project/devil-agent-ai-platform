  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Devil Agent Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Devil Agent &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Devil Agent?{' '}
        <a
