...
description: "Complete guide to migrating your OpenClaw / Clawdbot setup to Devil Agent Agent — what gets migrated, how config maps, and what to check after."
---

# Migrate from OpenClaw

`hermes claw migrate` imports your OpenClaw (or legacy Clawdbot/Moldbot) setup into Devil Agent. This guide covers exactly what gets migrated, the config key mappings, and what to verify after migration.
...
| What | OpenClaw source | Devil Agent destination | Notes |
|------|----------------|-------------------|-------|
...
| Source | OpenClaw location | Devil Agent destination |
|--------|------------------|-------------------|
...
Skill conflicts are handled by `--skill-conflict`: `skip` leaves the existing Devil Agent skill, `overwrite` replaces it, `rename` creates a `-imported` copy.

### Model and provider configuration

| What | OpenClaw config path | Devil Agent destination | Notes |
|------|---------------------|-------------------|-------|
...
| What | OpenClaw config path | Devil Agent config path | Mapping |
|------|---------------------|-------------------|---------|
...
| OpenClaw config path | Devil Agent config path | Notes |
|---------------------|-------------------|-------|
...
| OpenClaw field | Devil Agent field | Notes |
|----------------|-------------|-------|
...
| Platform | OpenClaw config path | Devil Agent `.env` variable | Notes |
|----------|---------------------|----------------------|-------|
...
| What | OpenClaw path | Devil Agent path | Notes |
|------|-------------|-------------|-------|
...
### Archived (no direct Devil Agent equivalent)

These are saved to `~/.hermes/migration/openclaw/<timestamp>/archive/` for manual review:

| What | Archive file | How to recreate in Devil Agent |
|------|-------------|--------------------------|
| `IDENTITY.md` | `archive/workspace/IDENTITY.md` | Merge into `SOUL.md` |
| `TOOLS.md` | `archive/workspace/TOOLS.md` | Devil Agent has built-in tool instructions |
...
| Multi-agent list | `archive/agents-list.json` | Use Devil Agent profiles |
