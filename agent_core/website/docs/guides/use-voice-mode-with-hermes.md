---
sidebar_position: 8
title: "Use Voice Mode with Devil Agent"
description: "A practical guide to setting up and using Devil Agent voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Devil Agent
...
- you want Devil Agent sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Devil Agent.
...
## Step 1: make sure normal Devil Agent works first
...
Devil Agent supports both local and cloud speech stacks.
...
4. Devil Agent transcribes and responds
...
- asking Devil Agent to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Devil Agent loop.

## Tuning CLI behavior

### Silence threshold

If Devil Agent starts/stops too aggressively, tune:
...
Devil Agent stays a normal chat bot, but can speak replies.
...
- you want Devil Agent to function like a portable research or ops assistant
...
Devil Agent joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Devil Agent detects speech boundaries
- transcripts are posted in the associated text channel
- Devil Agent responds in text and audio
...
1. get text Devil Agent working
