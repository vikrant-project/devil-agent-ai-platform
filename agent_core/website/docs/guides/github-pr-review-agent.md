...
┌───────────────────────────────────────────────────────────────────┐
│                                                                   │
│   Cron Timer  ──▶  Devil Agent Agent  ──▶  GitHub API  ──▶  Review     │
...
If you have a public endpoint available, check out [Automated GitHub PR Comments with Webhooks](./webhook-github-pr-review.md) — GitHub pushes events to Devil Agent instantly when PRs are opened or updated.
:::
...
- **Devil Agent Agent installed** — see the [Installation guide](/docs/getting-started/installation)
...
Make sure Devil Agent can access GitHub. Start a chat:
...
Still in the chat, ask Devil Agent to review a real PR:
...
A skill gives Devil Agent consistent review guidelines that persist across sessions and cron runs. Without one, review quality varies.
...
This is what makes the reviewer actually useful. Start a session and teach Devil Agent your team's standards:
...
2. Teach Devil Agent your conventions via memory (Step 4)
