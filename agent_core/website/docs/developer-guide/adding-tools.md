...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Devil Agent Agent — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Devil Agent tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying Devil Agent core, use the plugin route instead:

- [Plugins](/docs/user-guide/features/plugins)
- [Build a Devil Agent Plugin](/docs/guides/build-a-hermes-plugin)
