...
description: "How to build an image-generation backend plugin for Devil Agent Agent"
---
...
:::tip
Image-gen is one of several **backend plugins** Devil Agent supports. The others (with more specialized ABCs) are [Memory Provider Plugins](/docs/developer-guide/memory-provider-plugin), [Context Engine Plugins](/docs/developer-guide/context-engine-plugin), and [Model Provider Plugins](/docs/developer-guide/model-provider-plugin). General tool/hook/CLI plugins live in [Build a Devil Agent Plugin](/docs/guides/build-a-hermes-plugin).
:::

## How discovery works

Devil Agent scans for image-gen backends in three places:
...
- [Build a Devil Agent Plugin](/docs/guides/build-a-hermes-plugin) — general tools/hooks/slash commands guide
