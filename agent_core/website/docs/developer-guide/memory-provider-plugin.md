...
description: "How to build a memory provider plugin for Devil Agent Agent"
---

# Building a Memory Provider Plugin

Memory provider plugins give Devil Agent Agent persistent, cross-session knowledge beyond the built-in MEMORY.md and USER.md. This guide covers how to build one.
