...
## Devil Agent Agent Integration

This skill is designed for the Devil Agent agent. It uses Devil Agent tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Devil Agent skills for specific phases:
