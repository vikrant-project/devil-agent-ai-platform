...
| Version | `1.1.0` |
| Author | Devil Agent Agent (adapted from obra/superpowers) |
| License | MIT |
...
> **For Devil Agent:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Devil Agent tools to understand the project:
