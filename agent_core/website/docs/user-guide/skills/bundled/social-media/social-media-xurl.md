...
| Version | `1.1.1` |
| Author | xdevplatform + openclaw + Devil Agent Agent |
| License | MIT |
...
- Devil Agent adaptation: reformatted for Devil Agent skill conventions; safety guardrails preserved verbatim.
