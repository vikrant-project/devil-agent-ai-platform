...
| Version | `1.0.0` |
| Author | Devil Agent Agent (adapted from gsd-build/get-shit-done) |
| License | MIT |
...
**Verify variants visually — use Devil Agent' browser tools.** Don't just write HTML and hope it renders; load each variant and look at it:
