...
- User wants **Devil Agent itself to drive a browser** → use Devil Agent' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
