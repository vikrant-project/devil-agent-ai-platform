...
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Devil Agent Agent |
| License | MIT |
...
import upstream classes into Devil Agent itself.
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Devil Agent core.
