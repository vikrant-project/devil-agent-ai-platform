...
Type `@` followed by a reference to inject content directly into your message. Devil Agent expands the reference inline and appends the content under an `--- Attached Context ---` section.
...
- Devil Agent env: `$HERMES_HOME/.env`
