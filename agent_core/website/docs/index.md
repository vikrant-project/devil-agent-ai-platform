...
slug: /
sidebar_position: 0
title: "Devil Agent Agent Documentation"
...
| 🔌 **[MCP Integration](/docs/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Devil Agent safely |
| 🧭 **[Use MCP with Devil Agent](/docs/guides/use-mcp-with-hermes)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/docs/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Devil Agent](/docs/guides/use-voice-mode-with-hermes)** | Hands-on setup and usage patterns for Devil Agent voice workflows |
| 🎭 **[Personality & SOUL.md](/docs/user-guide/features/personality)** | Define Devil Agent' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/docs/guides/tips)** | Quick wins to get the most out of Devil Agent |
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind Devil Agent, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind Devil Agent, Nomos, and Psyche models
