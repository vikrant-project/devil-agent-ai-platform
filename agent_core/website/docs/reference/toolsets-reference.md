...
description: "Reference for Devil Agent core, composite, platform, and dynamic toolsets"
---
...
| `code_execution` | `execute_code` | Run Python scripts that call Devil Agent tools programmatically. |
