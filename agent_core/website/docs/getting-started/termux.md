...
description: "Run Devil Agent Agent directly on an Android phone with Termux"
---

# Devil Agent on Android with Termux

This is the tested path for running Devil Agent Agent directly on an Android phone through [Termux](https://termux.dev/).
...
That does not stop Devil Agent from working well as a phone-native CLI agent — it just means the recommended mobile install is intentionally narrower than the desktop/server install.

---

## Option 1: One-line installer

Devil Agent now ships a Termux-aware installer path:
