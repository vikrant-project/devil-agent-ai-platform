...
2. User plugins: ``$DEVIL_HOME/plugins/model-providers/<name>/``
...
def register_provider(profile: ProviderProfile) -> None:
    ...
    plugins under ``$DEVIL_HOME/plugins/model-providers/`` can override
...
def _user_plugins_dir() -> Path | None:
    """Return ``$DEVIL_HOME/plugins/model-providers/`` if it exists."""
    try:
        from devil_constants import get_devil_home

        d = get_devil_home() / "plugins" / "model-providers"
...
def _import_plugin_dir(plugin_dir: Path, source: str) -> None:
    ...
    # multiple DEVIL_HOME profiles don't alias each other.
...
def _discover_providers() -> None:
    ...
    Order:
      ...
      2. User plugins at ``$DEVIL_HOME/plugins/model-providers/<name>/``
    ...
    # 2. User plugins — under $DEVIL_HOME/plugins/model-providers/<name>/.
