...
// (e.g. https://mission-control.tilos.com/devil/). The Python backend
...
const SESSION_HEADER = "X-Devil Agent-Session-Token";
...
async function getSessionToken(): Promise<string> {
  ...
  throw new Error("Session token not available — page must be served by the Devil Agent dashboard server");
}
...
export const api = {
  ...
  updateDevil Agent: () =>
    fetchJSON<ActionResponse>("/api/devil/update", { method: "POST" }),
