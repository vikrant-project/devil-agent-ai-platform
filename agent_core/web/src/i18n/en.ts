...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateDevil Agent: "Update Devil Agent",
    updatingDevil Agent: "Updating Devil Agent…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Devil Agent plugins (`devil plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.devil/plugins/?",
    removeHint: "Only user-installed plugins under ~/.devil/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.devil/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Devil Agent badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Devil Agent session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Devil Agent more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Devil Agent sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Devil Agent is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
