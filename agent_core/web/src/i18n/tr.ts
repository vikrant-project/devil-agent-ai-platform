...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateDevil Agent: "Devil Agent'i Güncelle",
    updatingDevil Agent: "Devil Agent güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "Devil Agent eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`devil plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.devil/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.devil/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.devil/skills/ adresinden yüklenir",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk Devil Agent rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "Devil Agent oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "Devil Agent'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. Devil Agent ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "Devil Agent yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
