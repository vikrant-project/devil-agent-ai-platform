...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateDevil Agent: "Devil Agent aktualisieren",
    updatingDevil Agent: "Devil Agent wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "Devil Agent-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `devil plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.devil/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.devil/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.devil/skills/ geladen",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare Devil Agent-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "Devil Agent-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze Devil Agent mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald Devil Agent ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "Devil Agent scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
