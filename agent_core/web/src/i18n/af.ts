...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateDevil Agent: "Werk Devil Agent op",
    updatingDevil Agent: "Besig om Devil Agent op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Devil Agent-inproppe op (`devil plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.devil/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.devil/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.devil/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare Devil Agent-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "Devil Agent-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Devil Agent meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Devil Agent 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Devil Agent skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
