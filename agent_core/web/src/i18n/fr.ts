...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateDevil Agent: "Mettre à jour Devil Agent",
    updatingDevil Agent: "Mise à jour de Devil Agent…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Devil Agent (parité avec `devil plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.devil/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.devil/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.devil/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "Devil Agent Achievements",
      subtitle:
        "Badges Devil Agent à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Devil Agent en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Devil Agent davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Devil Agent détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Devil Agent analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Devil Agent Agent ☤",
    },
  },
  kanban: {
