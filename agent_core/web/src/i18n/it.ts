...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateDevil Agent: "Aggiorna Devil Agent",
    updatingDevil Agent: "Aggiornamento di Devil Agent…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Devil Agent (parità con `devil plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.devil/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.devil/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.devil/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge Devil Agent da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni Devil Agent in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa Devil Agent di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando Devil Agent rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "Devil Agent sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
