          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="devil-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="devil-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({ onNavigate }: { onNavigate: () => void }) {
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateDevil Agent,
      runningLabel: t.status.updatingDevil Agent,
      spin: false,
    },
  ];
