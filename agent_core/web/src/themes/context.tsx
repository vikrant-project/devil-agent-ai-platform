...
const STORAGE_KEY = "devil-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `devil_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "devil-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-devil-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-devil-theme-font", "true");
