...
from devil_cli.timeouts import (
...
_loaded_env_paths = load_devil_dotenv(devil_home=_devil_home, project_env=_project_env)
...
def _routermint_headers() -> dict:
    ...
    from devil_cli import __version__ as _DEVIL_VERSION

    return {
        "User-Agent": f"HermesAgent/{_DEVIL_VERSION}",
    }
...
class AIAgent:
    ...
    def __init__(
        ...
        Args:
            ...
            load_soul_identity (bool): If True, still use ~/.devil/SOUL.md as the primary
        ...
        self._cache_ttl = "5m"
        try:
            from devil_cli.config import load_config as _load_pc_cfg
        ...
        # both live under ~/.devil/logs/.  Idempotent, so gateway mode
        # (which creates a new AIAgent per message) won't duplicate handlers.
        from devil_logging import setup_logging, setup_verbose_logging
        setup_logging(devil_home=_devil_home)
        ...
        if self.verbose_logging:
            ...
            # on the fact that devil_logging.setup_logging() does not
            ...
            # handler level inside devil_logging.py, not here.
            pass
        ...
        if self.api_mode == "anthropic_messages":
            ...
            try:
                from devil_cli.config import load_config as _load_br_cfg
            ...
            if api_key and base_url:
                ...
                if base_url_host_matches(effective_base, "openrouter.ai"):
                    ...
                    from devil_cli.models import copilot_default_headers
        ...
        os.environ["DEVIL_SESSION_ID"] = self.session_id
        try:
        ...
        # Session logs go into ~/.devil/sessions/ alongside gateway sessions
        devil_home = get_devil_home()
        self.logs_dir = devil_home / "sessions"
        ...
        try:
            from devil_cli.config import load_config as _load_agent_config
                ...
                if _mem_provider_name:
                    ...
                    if self._memory_manager.providers:
                        ...
                        try:
                            ...
                            _init_kwargs["agent_workspace"] = "devil"
                        except Exception:
                            pass
        ...
        if _config_context_length is None and _custom_providers:
            try:
                from devil_cli.config import get_custom_provider_context_length
        ...
        if _engine_name != "compressor":
            ...
            if _selected_engine is None:
                try:
                    from devil_cli.plugins import get_plugin_context_engine
        ...
        if _ctx and _ctx < MINIMUM_CONTEXT_LENGTH:
            raise ValueError(
                ...
                f"by Devil Agent.  Choose a model with at least "
    ...
    def _ensure_db_session(self) -> None:
        ...
        try:
            self._session_db.create_session(
                session_id=self.session_id,
                source=self.platform or os.environ.get("DEVIL_SESSION_SOURCE", "cli"),
                model=self.model,
    ...
    def _ensure_lmstudio_runtime_loaded(self, config_context_length: Optional[int] = None) -> None:
        ...
        try:
            from agent.model_metadata import MINIMUM_CONTEXT_LENGTH
            from devil_cli.models import ensure_lmstudio_model_loaded
    ...
    def switch_model(self, new_model, new_provider, api_key='', base_url='', api_mode=''):
        ...
        turn-scoped).
        """
        from devil_cli.providers import determine_api_mode
        ...
        if hasattr(self, "context_compressor") and self.context_compressor:
            ...
            try:
                from devil_cli.config import load_config, get_compatible_custom_providers
                _sm_cfg = load_config()
    ...
    def _resolved_api_call_timeout(self) -> float:
        ...
        Priority:
          ...
          3. ``DEVIL_API_TIMEOUT`` env var (legacy escape hatch)
          4. 1800.0s default
        ...
        helper, the hardcoded ``DEVIL_API_TIMEOUT`` fallback would always be
        ...
        if cfg is not None:
            return cfg
        return float(os.getenv("DEVIL_API_TIMEOUT", 1800.0))
    ...
    def _resolved_api_call_stale_timeout_base(self) -> tuple[float, bool]:
        ...
        Priority:
          ...
          3. ``DEVIL_API_CALL_STALE_TIMEOUT`` env var
          4. 300.0s default
        ...
        env_timeout = os.getenv("DEVIL_API_CALL_STALE_TIMEOUT")
    ...
    def _provider_model_requires_responses_api(
        ...
        *,
        ...
        if normalized_provider == "copilot":
            try:
                from devil_cli.models import _should_use_copilot_responses_api
    ...
    def _build_memory_write_metadata(
        ...
        *,
        ...
        metadata: Dict[str, Any] = {
            ...
            "platform": self.platform or os.environ.get("DEVIL_SESSION_SOURCE", "cli"),
            "tool_name": "memory",
        }
        if task_id:
    ...
    def _dump_api_request_debug(
        ...
        *,
        ...
        try:
            ...
            if env_var_enabled("DEVIL_DUMP_REQUEST_STDOUT"):
    ...
    def _build_system_prompt_parts(self, system_message: str = None) -> Dict[str, str]:
        ...
        # Some execution modes (cron) still want DEVIL_HOME persona while keeping
        ...
        stable_parts.append(DEVIL_AGENT_HELP_GUIDANCE)
        ...
        # DEVIL_KANBAN_TASK env var). Normal chat sessions never see
        # this block.
        ...
        from devil_time import now as _hermes_now
        now = _hermes_now()
    ...
    def _copilot_headers_for_request(self, *, is_vision: bool) -> dict:
        from devil_cli.copilot_auth import copilot_request_headers
    ...
    def _try_refresh_codex_client_credentials(self, *, force: bool = True) -> bool:
        ...
        try:
            if self.provider == "openai-codex":
                ...
                from devil_cli.auth import resolve_xai_oauth_runtime_credentials
    ...
    def _try_refresh_nous_client_credentials(self, *, force: bool = True) -> bool:
        ...
        try:
            from devil_cli.auth import resolve_nous_runtime_credentials

            creds = resolve_nous_runtime_credentials(
                min_key_ttl_seconds=max(60, int(os.getenv("DEVIL_NOUS_MIN_KEY_TTL_SECONDS", "1800"))),
                timeout_seconds=float(os.getenv("DEVIL_NOUS_TIMEOUT_SECONDS", "15")),
                force_mint=force,
            )
        except Exception as exc:
    ...
    def _try_refresh_copilot_client_credentials(self) -> bool:
        ...
        try:
            from devil_cli.copilot_auth import resolve_copilot_token
    ...
    def _interruptible_streaming_api_call(
        ...
        def _call_chat_completions():
            ...
            # wins over the DEVIL_API_TIMEOUT env default if the user set it.
            _provider_timeout_cfg = get_provider_request_timeout(self.provider, self.model)
            _base_timeout = (
                _provider_timeout_cfg
                if _provider_timeout_cfg is not None
                else float(os.getenv("DEVIL_API_TIMEOUT", 1800.0))
            )
            # Read timeout: config wins here too.  Otherwise use
            # DEVIL_STREAM_READ_TIMEOUT (default 120s) for cloud providers.
            if _provider_timeout_cfg is not None:
                _stream_read_timeout = _provider_timeout_cfg
            else:
                _stream_read_timeout = float(os.getenv("DEVIL_STREAM_READ_TIMEOUT", 120.0))
                # Local providers (Ollama, llama.cpp, vLLM) can take minutes for
                # prefill on large contexts before producing the first token.
                # Auto-increase the httpx read timeout unless the user explicitly
                # overrode DEVIL_STREAM_READ_TIMEOUT.
        ...
        def _call():
            ...
            _max_stream_retries = int(os.getenv("DEVIL_STREAM_RETRIES", 2))
        ...
        _stream_stale_timeout_base = float(os.getenv("DEVIL_STREAM_STALE_TIMEOUT", 180.0))
        # Local providers (Ollama, oMLX, llama-cpp) can take 300+ seconds
        # for prefill on large contexts.  Disable the stale detector unless
        # the user explicitly set DEVIL_STREAM_STALE_TIMEOUT.
    ...
    def _try_activate_fallback(self, reason: "FailoverReason | None" = None) -> bool:
        ...
        try:
            ...
            if not fb_api_key_hint:
                ...
                # _normalize_custom_provider_entry in devil_cli/config.py).
            ...
            try:
                from devil_cli.model_normalize import normalize_model_for_provider
    ...
    def _build_api_kwargs(self, api_messages: list) -> dict:
        ...
        if _is_qwen:
            _qwen_meta = {
                "sessionId": self.session_id or "devil",
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        if (
            ...
            try:
                from devil_cli.models import github_model_reasoning_efforts
    ...
    def _lmstudio_reasoning_options_cached(self) -> list[str]:
        ...
        if cached is not None:
            ...
            if opts or (_time.monotonic() - ts) < 60:
                return opts
        try:
            from devil_cli.models import lmstudio_model_reasoning_options
    ...
    def _invoke_tool(self, function_name: str, function_args: dict, effective_task_id: str,
        ...
        if not pre_tool_block_checked:
            try:
                from devil_cli.plugins import get_pre_tool_call_block_message
    ...
    def run_conversation(
        ...
        from devil_logging import set_session_context
        ...
        while (api_call_count < self.max_iterations and self.iteration_budget.remaining > 0) or self._budget_grace_call:
            ...
            while retry_count < max_retries:
                ...
                try:
                    ...
                    if env_var_enabled("DEVIL_DUMP_REQUESTS"):
        ...
        if final_response is None and (
            ...
            _kanban_task = os.environ.get("DEVIL_KANBAN_TASK")
            if _kanban_task:
                try:
                    handle_function_call(
                        "kanban_block",
